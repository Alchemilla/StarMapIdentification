...
public:
	...
	void StarMapForJL01(string outPath, vector<Quat>jlCam, StarCaliParam param);
	...
	void FromLL2XYForJL01(Star starCatlog, double* R, double& x, double& y, StarCaliParam param);//计算吉林一号恒星位置

...
int main(int argc, char* argv[])
{
	...
	double Optical_axis [] = {-0.59551143828591213, -0.76970238188778783, 0.23005297256699414};
	...
	double fov_radius = 8*PI/180;
	ZY3_ST.Create_Spherical_Polygon_Candidate_Set(Optical_axis,fov_radius);
	ZY3_ST.candidate_radius = 25*5e-6;
	ZY3_ST.match_tolerance = 500*5e-6;
	ZY3_ST.Identify_Basis_Pair(obs);
	return 0;
}
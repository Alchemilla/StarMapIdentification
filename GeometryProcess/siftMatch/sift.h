// sift.h: interface for the sift class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_SIFT_H__5A90F011_1BF3_49FD_91E1_CCF91E639B02__INCLUDED_)
#define AFX_SIFT_H__5A90F011_1BF3_49FD_91E1_CCF91E639B02__INCLUDED_
...
#define SIFT_CONTR_THR 0.06  //默认给的是0.04
...
extern int sift_features( float *BlockImg, int Width,int Height,float maxgray, struct feature** feat );
extern int sift_featuresblock( float *BlockImg, int Width,int Height, struct feature** feat );
...
extern int _sift_features( float *BlockImg, int Width,int Height,float maxgray,struct feature** feat, int intvls,
				   double sigma, double contr_thr, int curv_thr,
				   int img_dbl, int descr_width, int descr_hist_bins );
extern int _sift_featuresblock( float *BlockImg, int Width,int Height,struct feature** feat, int intvls,
				   double sigma, double contr_thr, int curv_thr,
				   int img_dbl, int descr_width, int descr_hist_bins );
...
#endif // !defined(AFX_SIFT_H__5A90F011_1BF3_49FD_91E1_CCF91E639B02__INCLUDED_)

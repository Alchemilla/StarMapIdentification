...
#ifdef TRILIBRARY
  if (!b->quiet) {
    //Edit By pzhou //printf("Writing vertices.\n");
  }
...
#ifdef TRILIBRARY
  if (!b->quiet) {
    //Edit By Pzhou //printf("Writing triangles.\n");
  }
...
#ifdef TRILIBRARY
  if (!b->quiet) {
	  //Edit By Pzhou //printf("Writing segments.\n");
  }
...
#ifdef TRILIBRARY
  if (!b->quiet) {
	  //Edit By Pzhou //printf("Writing neighbors.\n");
  }
